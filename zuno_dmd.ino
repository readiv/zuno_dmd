...
#define pin_rellay_2 22  //пин реле 1 для включения нагрузки
...
byte attempts_led_1 = 0; //Попытки переключить led 1
byte attempts_led_2 = 0; //Попытки переключить led 1
...
//  Читаем светодиоды и выключатели
  ...
  if (z_led_1 != 10) { //Поступила комманда от z-wave на кнопку 1
    if (z_led_1 != led_1 && attempts_led_1<3) { //Разные состояния. И число попыток меньше 3. Эммулируем нажатия сенсерной кнопки
  ...
  if (z_led_2 != 10) { //Поступила комманда от z-wave на кнопку 2
    if (z_led_2 != led_2 && attempts_led_2<3) { //Разные состояния. И число попыток меньше 3. Эммулируем нажатия сенсерной кнопки
